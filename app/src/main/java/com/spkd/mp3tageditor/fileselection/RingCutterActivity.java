...
import com.spkd.mp3editor.soundfile.CheapSoundFile;
 ...
 */
public class RingCutterActivity
    ...
    implements TextWatcher
{
    ...
    private void confirmDelete() {
        ...
        new AlertDialog.Builder(RingCutterActivity.this)
            .setTitle(title)
            .setMessage(message)
            .setPositiveButton(
